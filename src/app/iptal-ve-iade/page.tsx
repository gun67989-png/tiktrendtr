      ...
      <div className="pt-28 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">1. Genel Bilgi</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">2. Abonelik İptali</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">3. İade Politikası</h2>
              <p className="mb-3">
              ...
              <div className="bg-surface-light border border-border rounded-xl p-4 mb-3">
                <h3 className="text-sm font-semibold text-text-primary mb-2">İade Yapılabilecek Durumlar:</h3>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li><strong className="text-text-primary">İlk Abonelik İadesi:</strong> İlk kez Pro Plan&apos;a abone olan kullanıcılar, abonelik başlangıcından itibaren 7 gün içinde tam iade talep edebilir.</li>
                  <li><strong className="text-text-primary">Teknik Aksaklık:</strong> Platform kaynaklı teknik sorunlar nedeniyle hizmetten yararlanamama durumunda, etkilenen dönem için iade yapılabilir.</li>
                  <li><strong className="text-text-primary">Mükerrer Ödeme:</strong> Sistem kaynaklı mükerrer (çift) çekim yapılması durumunda fazla ödeme derhal iade edilir.</li>
                </ul>
              </div>

              <div className="bg-surface-light border border-border rounded-xl p-4">
                <h3 className="text-sm font-semibold text-text-primary mb-2">İade Yapılmayacak Durumlar:</h3>
                <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">4. İade Süreci</h2>
              <ol className="list-decimal list-inside space-y-2 ml-2">
                <li>
                  <strong className="text-text-primary">Başvuru:</strong> destek@valyze.app adresine e-posta göndererek
                  iade talebinizi iletin. E-postanızda kayıtlı e-posta adresinizi ve iade gerekçenizi belirtin.
                </li>
                <li>
                  <strong className="text-text-primary">Değerlendirme:</strong> Talebiniz en geç 3 iş günü içinde
                  incelenir ve sonuç e-posta ile bildirilir.
                </li>
                <li>
                  <strong className="text-text-primary">İade İşlemi:</strong> Onaylanan iadeler, ödemenin yapıldığı
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">5. Fiyat Değişiklikleri</h2>
              <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <section>
              <h2 className="text-lg font-semibold text-text-primary mb-3">6. İletişim</h2>
              ...
              <ul className="list-none space-y-1 ml-2 mt-2">
                ...
                <li><strong className="text-text-primary">İletişim Formu:</strong>{" "}
                  <Link href="/contact" className="text-neon-red hover:underline">valyze.vercel.app/contact</Link>
                </li>
                <li><strong className="text-text-primary">Yanıt Süresi:</strong> En geç 24 saat içinde</li>
              </ul>
            </section>
          </div>
        </div>
