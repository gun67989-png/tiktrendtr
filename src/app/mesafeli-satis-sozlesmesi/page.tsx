        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              ...
              <p><strong className="text-foreground">SATICI:</strong></p>
              ...
              <p className="mt-3"><strong className="text-foreground">ALICI:</strong></p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">2. Sözleşmenin Konusu</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">3. Sözleşme Konusu Hizmet</h2>
              <p className="mb-2">Satışa konu dijital hizmetin özellikleri:</p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li><strong className="text-foreground">Hizmet Adı:</strong> Valyze TR - TikTok Trend Analiz Platformu</li>
                <li><strong className="text-foreground">Hizmet Türü:</strong> SaaS (Hizmet Olarak Yazılım) - Dijital abonelik hizmeti</li>
                <li><strong className="text-foreground">Pro Plan Ücreti:</strong> Aylık 299 TL (KDV dahil)</li>
                <li><strong className="text-foreground">Ücretsiz Plan:</strong> Sınırlı özelliklere erişim, ücret alınmaz</li>
              </ul>
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">4. Hizmet Bedeli ve Ödeme</h2>
              <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">5. Hizmetin İfası ve Teslimat</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">6. Cayma Hakkı</h2>
              <p>
              ...
              <p className="mt-2">
                ...
                abonelik başlangıcından itibaren <strong className="text-foreground">7 gün içinde</strong> destek@valyze.app
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">7. Genel Hükümler</h2>
              <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">8. Uyuşmazlık Çözümü</h2>
              <p>
            ...
            <section>
              ...
              <ul className="list-none space-y-1 ml-2 mt-2">
                ...
                <li><strong className="text-foreground">Web:</strong> https://valyze.vercel.app/contact</li>
              </ul>
            </section>
          </div>
        </div>
