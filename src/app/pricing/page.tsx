...
import { Check, ArrowLeft, Zap, Star, AlertCircle, CheckCircle, Loader } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">Başlangıç için</p>
            </div>
            ...
            <Link
              ...
              className="block w-full text-center py-3 px-6 rounded-xl border border-border text-foreground font-medium hover:bg-muted transition-all"
            >
          ...
          <motion.div
            ...
            className="bg-card rounded-xl border-2 border-primary/30 p-8 relative"
          >
            {/* Popular badge */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <div className="bg-primary text-white text-xs font-bold px-4 py-1 rounded-full flex items-center gap-1.5">
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">Profesyonel içerik üreticileri için</p>
            </div>
            ...
            {isPremium ? (
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="block w-full text-center py-3 px-6 rounded-md bg-primary text-white font-semibold hover:bg-primary/80 transition-colors"
                >
                  Aylık Abone Ol
                </button>
                <button
                  onClick={() => handleProClick("single")}
                  className="block w-full text-center py-2.5 px-6 rounded-xl border border-border text-muted-foreground text-sm font-medium hover:bg-muted transition-all"
                >
                  Tek Seferlik 30 Gün
                </button>
              </div>
